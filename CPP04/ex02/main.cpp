...
void	printType( const AAnimal *AAnimal )
{
	std::cout << AAnimal->getType() << std::endl;
}

void	printType( const WrongAnimal *AAnimal )
{
	std::cout << AAnimal->getType() << std::endl;
}
...
void	checkingBrains()
{
	std::cout << "#### CHECKING AAnimal BRAINS AND DEEP COPY ####\n";
...
{
	std::cout << "#### CHECKING Abstract Animal Class ####\n";

	std::cout << "Uncomment following Code to prove that AAnimal is a pure abstract Class\n"
...
/* 	{
	...
	std::cout << "\nABSTRACT ANIMAL CLASS CHECKS COMPLETED\n" << std::endl;
}
